...
exports.addMojangAccount = async function(username, password) {
    ...
    if (username === '') return Promise.reject(mojangErrorDisplayable(response.mojangErrorCode))
    if (password === '') {
        ...
        const ret = ConfigManager.addMojangAuthAccount(uuidv3(username + machineIdSync(), uuidv3.DNS), 'Piston#3983', username, username)
        if (ConfigManager.getClientToken() == null) {
            ConfigManager.setClientToken('Piston#3983')
        }
        ConfigManager.save()
        return ret
    }
...
exports.validateSelected = async function(){
    ...
    if (ConfigManager.getClientToken() === 'Piston#3983') {
        return true
    }
